...
From the [docs](https://modal.com/docs/guide/custom-container):
...
✓ Initialized. View run at https://modal.com/charlotte-llm/main/apps/ap-xxxxxxxxxx
✓ Created objects.
├── 🔨 Created mount /Users/ryan/Desktop/Desktop - Ryan’s iMac/personal/modal-examples/02_building_containers/import_sklearn_r2.py
└── 🔨 Created function fit_r2.
Inside run!
...
It's important to mindful of scope of local vs. remote when using Modal. This will be an extended discussion we'll see in later examples.
